...
public class InMemoryPersistenceTest {
    ...
    public void getBluePrintByAuthorTest() throws BlueprintPersistenceException, BlueprintNotFoundException{
        ...
        assertEquals(prueba,ibpp.getBlueprintByAuthor("john"));
        
    }
    
    
    @Test
    public void getAllBluePrint() throws BlueprintPersistenceException, BlueprintNotFoundException{
        InMemoryBlueprintPersistence ibpp=new InMemoryBlueprintPersistence();
        Set<Blueprint> prueba = ibpp.getAllBlueprints();
        assertEquals(prueba,ibpp.getAllBlueprints());
